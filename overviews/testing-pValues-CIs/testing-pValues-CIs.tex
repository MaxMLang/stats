...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{testing-pValues-CIs/figures/one-tailed-power.png}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{testing-pValues-CIs/figures/two-tailed-power.png}
\end{figure}
